...
export FZF_ALT_C_COMMAND='find / -type d ! -path "*\.git*" ! -path "*venv*" ! -path "*__pycache__*" ! -path "*sublime-history*" 2>/dev/null'
export FZF_CTRL_T_COMMAND='find / -type f ! -path "*\.git*" ! -path "*venv*" ! -path "*__pycache__*" ! -path "*sublime-history*" 2>/dev/null'
export WORDCHARS="*?_-.[]~=:&;!#$%^(){}<>"
