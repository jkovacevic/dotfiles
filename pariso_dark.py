...
class ParaisoDarkStyle(Style):
    ...
    styles = {
        ...
        Punctuation:               "bold " + DARK_RED,  # class: 'p'
        ...
        String.Other:              ORANGE,          # class: 'sx'
        String.Regex:              ORANGE,          # class: 'sr'
        String.Single:             ORANGE,          # class: 's1'
        String.Symbol:             ORANGE,          # class: 'ss'

        Generic:                   "",                    # class: 'g'
        Generic.Deleted:           RED,                   # class: 'gd',
        Generic.Emph:              "italic",              # class: 'ge'
        Generic.Error:             ORANGE,                    # class: 'gr'
